...
requireRole(['admin', 'manager', 'staff_warehouse', 'staff_keuangan', 'cabang']);
...
// Get header
$stmt = $conn->prepare("
    SELECT so.*, b.branch_name, b.address, u.full_name as created_by_name
    FROM stock_out so
...
<div class="detail-grid">
    <div class="detail-item">
        <div class="detail-label">Kode Distribusi</div>
    ...
    <div class="detail-item">
        <div class="detail-label">Cabang Tujuan</div>
        <div class="detail-value"><?php echo $trans['branch_name']; ?></div>
    </div>
    <div class="detail-item">
        <div class="detail-label">Dibuat Oleh</div>
        <div class="detail-value"><?php echo $trans['created_by_name']; ?></div>
    </div>
    <?php if ($trans['address']): ?>
    <div class="detail-item" style="grid-column: 1 / -1;">
        <div class="detail-label">Alamat Cabang</div>
        <div class="detail-value"><?php echo nl2br($trans['address']); ?></div>
    </div>
    <?php endif; ?>
    <?php if ($trans['notes']): ?>
    <div class="detail-item" style="grid-column: 1 / -1;">
...
<div class="total-row">
    ...
    <strong style="font-size: 24px; color: var(--success-color);"><?php echo formatRupiah($trans['total_amount']); ?></strong>
</div>
