...
<head>
    ...
    <link rel="stylesheet" href="assets/css/custom-datepicker.css">
    ...
    <nav class="navbar">
        <div class="navbar-container">
            ...
            <div class="navbar-actions">
                ...
                <a href="users.php" class="theme-toggle-btn <?php echo $current_page === 'users.php' ? 'active-icon' : ''; ?>" title="User Management" style="text-decoration: none;">
