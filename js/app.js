...
function updateButtonStates() {
    ...
    // 🔧 FIX: If stepper is active, also update stepper navigation buttons
    if (window.stepperNav && typeof window.stepperNav.updateNavigationButtons === 'function') {
        console.log('🔄 Triggering stepper navigation update from app.js updateButtonStates...');
        setTimeout(() => {
            window.stepperNav.updateNavigationButtons();
        }, 50);
    }
