...
function validateStep3() {
    ...
    const nominalValue = nominal ? nominal.replace(/[^\d]/g, '') : '';
    const nominalInt = nominalValue ? parseInt(nominalValue) : 0;
    const isValid = tipePembayaran && nominalValue && nominalInt >= 10000;

    console.log('🔍 Step 3 Validation:', {
        tipePembayaran: tipePembayaran,
        tipePembayaranFilled: !!tipePembayaran,
        nominal: nominal,
        nominalValue: nominalValue,
        nominalInt: nominalInt,
        isNominalValid: nominalInt >= 10000,
        isValid: isValid
    });
